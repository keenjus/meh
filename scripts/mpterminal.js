    ...
    function MPTerminal(selector) {
        ...
        this.handleInput = function (event) {
            ...
            switch (event.keyCode) {
                case 13:
                    var scrolledToBottom = _this.messagesWindow.scrollTop === (_this.messagesWindow.scrollHeight - _this.messagesWindow.offsetHeight);
                    _this.history.push(input.value);
                    _this.printToConsole(input.value);
                    input.value = "";
                    if (scrolledToBottom) {
                        _this.messagesWindow.scrollTop = _this.messagesWindow.scrollHeight;
                    }
                    break;
                case 38:
